    ...
    <section className="mx-auto max-w-7xl px-6 py-12">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[#0F172A] p-10 md:p-14 text-white shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <button className="group flex items-center justify-center gap-3 rounded-2xl bg-white/10 px-8 py-5 text-lg font-bold backdrop-blur-md transition-all hover:bg-white hover:text-[#0F172A]">
            <ShoppingBag className="h-5 w-5" />
            Contact for Bulk Price
          </button>
        </div>
      </div>
    </section>
